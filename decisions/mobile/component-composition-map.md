...
适用于 `tdesign-mobile-react`、`tdesign-mobile-vue` 和 `tdesign-miniprogram`。本文只给 Mobile / Miniprogram 组合方向，具体 props、事件、插槽、external classes 和平台能力必须查当前栈 `api/<stack>/<component>/index.md`。
...
- 小程序上传能力受微信平台 API 约束，必须查 `api/miniprogram/upload/index.md`。
