...
- 组件选型优先查 `decisions/web/component-usage-map.md`、`decisions/similar-components.md` 和 `decisions/when-to-use/`。
...
- 组件选型优先查 `decisions/mobile/component-usage-map.md`，再查通用 `decisions/`。
