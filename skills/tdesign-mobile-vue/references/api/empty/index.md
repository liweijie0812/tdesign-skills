...
上游文档：https://raw.githubusercontent.com/Tencent/tdesign-mobile-vue/develop/src/empty/empty.md
...
icon | String / Slot / Function | - | 图标。TS 类型：`string \| TNode`。[通用类型定义](../common.ts) | N
