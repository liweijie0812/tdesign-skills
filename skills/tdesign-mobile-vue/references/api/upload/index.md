...
组件简介：用于相册读取或拉起拍照的图片上传功能。

上游文档：https://raw.githubusercontent.com/Tencent/tdesign-mobile-vue/develop/src/upload/upload.md
...
addContent | String / Slot / Function | - | 添加按钮内容。值为空，使用默认图标渲染；值为 slot 则表示使用插槽渲染；其他值无效。TS 类型：`string \| TNode`。[通用类型定义](../common.ts) | N
