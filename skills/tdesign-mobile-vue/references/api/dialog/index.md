...
上游文档：https://raw.githubusercontent.com/Tencent/tdesign-mobile-vue/develop/src/dialog/dialog.md
...
名称 | 类型 | 默认值 | 描述 | 必传
-- | -- | -- | -- | --
actions | Array / Slot / Function | - | 操作栏。TS 类型：`Array<ButtonProps>`，[Button API Documents](../button/index.md)。[详细类型定义](./type.ts) | N
...
middle | Slot / Function | - | 中间自定义内容。TS 类型：`TNode`。[通用类型定义](../common.ts) | N
overlayProps | Object | {} | 透传至 Overlay 组件。TS 类型：`OverlayProps`，[Overlay API Documents](../overlay/index.md)。[详细类型定义](./type.ts) | N
preventScrollThrough | Boolean | true | 防止滚动穿透 | N
showOverlay | Boolean | true | 是否显示遮罩层 | N
title | String / Slot / Function | - | 标题。TS 类型：`string \| TNode`。[通用类型定义](../common.ts) | N
top | Slot / Function | - | 顶部自定义内容。TS 类型：`TNode`。[通用类型定义](../common.ts) | N
...
onClose | Function |  | TS 类型：`(context: DialogCloseContext) => void`<br/>关闭事件，点击 取消按钮 或 点击蒙层 时触发。[详细类型定义](./type.ts)。<br/>`type DialogEventSource = 'cancel' \| 'overlay' \| 'close-btn'`<br/><br/>`interface DialogCloseContext { trigger: DialogEventSource; e: MouseEvent }`<br/> | N
...
close | `(context: DialogCloseContext)` | 关闭事件，点击 取消按钮 或 点击蒙层 时触发。[详细类型定义](./type.ts)。<br/>`type DialogEventSource = 'cancel' \| 'overlay' \| 'close-btn'`<br/><br/>`interface DialogCloseContext { trigger: DialogEventSource; e: MouseEvent }`<br/>
