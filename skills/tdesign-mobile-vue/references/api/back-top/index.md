...
组件简介：用于当页面过长往下滑动时，帮助用户快速回到页面顶部。

上游文档：https://raw.githubusercontent.com/Tencent/tdesign-mobile-vue/develop/src/back-top/back-top.md
...
icon | Boolean / Slot / Function | true | 图标。TS 类型：`boolean \| TNode`。[通用类型定义](../common.ts) | N
