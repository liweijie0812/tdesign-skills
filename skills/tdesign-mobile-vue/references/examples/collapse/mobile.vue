<!--
  TDesign TDesign Mobile Vue 示例：collapse - mobile
  覆盖组件：Collapse
  来源：组件库源码 src/collapse/demos/mobile.vue
-->

<template>
  <div class="tdesign-mobile-demo">
    <h1 class="title">Collapse 折叠面板</h1>
    <p class="summary">可以折叠/展开的内容区域。</p>
    <tdesign-demo-block summary="基础折叠面板" title="01 组件类型">
      <baseVue />
    </tdesign-demo-block>
    ...
    <tdesign-demo-block summary="卡片折叠面板" title="02 组件样式">
      <cardVue />
    </tdesign-demo-block>
  </div>
</template>
