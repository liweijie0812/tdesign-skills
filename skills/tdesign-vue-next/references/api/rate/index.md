...
上游文档：https://raw.githubusercontent.com/Tencent/tdesign-vue-next/develop/packages/components/rate/rate.md
...
icon | Slot / Function | - | 自定义评分图标。TS 类型：`TNode`。[通用类型定义](../common.ts) | N
