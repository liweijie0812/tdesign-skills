...
上游文档：https://raw.githubusercontent.com/Tencent/tdesign-react/develop/packages/components/skeleton/skeleton.md
...
children | TNode | - | 加载完成的内容，同 content。TS 类型：`string \| TNode`。[通用类型定义](../common.ts) | N
content | TNode | - | 加载完成的内容。TS 类型：`string \| TNode`。[通用类型定义](../common.ts) | N
