/**
 * TDesign TDesign React 示例：cascader - filterable
 * 覆盖组件：Cascader
 * 来源：组件库源码 packages/components/cascader/_example/filterable.tsx
 */
...
export default function Example() {
  ...
  const [value2, setValue2] = useState<CascaderValue>(['1.1']);
  const options = [
    {
      label: '当选项一数据展示文本过长时',
      value: '1',
