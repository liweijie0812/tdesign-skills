/**
 * TDesign TDesign React 示例：tag-input - draggable
 * 覆盖组件：Tag-input
 * 来源：组件库源码 packages/components/tag-input/_example/draggable.tsx
 */

import React, { useState } from 'react';
import { Space, TagInput } from 'tdesign-react';

import type { TagInputChangeContext, TagInputProps } from 'tdesign-react';
