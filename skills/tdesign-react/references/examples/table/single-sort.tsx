/**
 * TDesign TDesign React 示例：table - single-sort
 * 覆盖组件：Table
 * 来源：组件库源码 packages/components/table/_example/single-sort.tsx
 */
...
import type { SortInfo, TableProps, TableSort } from 'tdesign-react';
