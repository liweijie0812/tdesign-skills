/**
 * TDesign TDesign React 示例：table - drag-col-sort
 * 覆盖组件：Table
 * 来源：组件库源码 packages/components/table/_example/drag-col-sort.tsx
 */
...
const initialColumns: TableProps['columns'] = [
  { colKey: 'applicant', title: '申请人', width: '100', fixed: 'left' as const },
  {
    colKey: 'status',
    title: '申请状态',
    width: '150',
