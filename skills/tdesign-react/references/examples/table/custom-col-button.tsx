/**
 * TDesign TDesign React 示例：table - custom-col-button
 * 覆盖组件：Table
 * 来源：组件库源码 packages/components/table/_example/custom-col-button.tsx
 */
...
import type { CheckboxGroupValue, TableColumnController, TableProps } from 'tdesign-react';
