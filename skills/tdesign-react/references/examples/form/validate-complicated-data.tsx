/**
 * TDesign TDesign React 示例：form - validate-complicated-data
 * 覆盖组件：Form
 * 来源：组件库源码 packages/components/form/_example/validate-complicated-data.tsx
 */

import React, { useState } from 'react';
import { Button, Checkbox, Form, Input, MessagePlugin, Radio, Tabs } from 'tdesign-react';
