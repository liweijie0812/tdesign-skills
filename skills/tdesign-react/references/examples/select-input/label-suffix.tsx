/**
 * TDesign TDesign React 示例：select-input - label-suffix
 * 覆盖组件：Select-input
 * 来源：组件库源码 packages/components/select-input/_example/label-suffix.tsx
 */
...
export default function SelectInputSingle() {
  ...
  const onPopupVisibleChange2 = (val: boolean) => {
