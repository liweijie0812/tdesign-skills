/**
 * TDesign TDesign React 示例：select-input - borderless-multiple
 * 覆盖组件：Select-input
 * 来源：组件库源码 packages/components/select-input/_example/borderless-multiple.tsx
 */
...
import type { CheckboxGroupProps, CheckboxOptionObj, TagInputChangeContext, TagInputValue } from 'tdesign-react';
