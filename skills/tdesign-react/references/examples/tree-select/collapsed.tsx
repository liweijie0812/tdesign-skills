/**
 * TDesign TDesign React 示例：tree-select - collapsed
 * 覆盖组件：Tree-select
 * 来源：组件库源码 packages/components/tree-select/_example/collapsed.tsx
 */

import React, { useState } from 'react';
import { Space, Tag, Tooltip, TreeSelect } from 'tdesign-react';
