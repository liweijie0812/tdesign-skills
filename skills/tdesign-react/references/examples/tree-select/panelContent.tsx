/**
 * TDesign TDesign React 示例：tree-select - panelContent
 * 覆盖组件：Tree-select
 * 来源：组件库源码 packages/components/tree-select/_example/panelContent.tsx
 */

import React, { useState } from 'react';
import { Input, Space, TreeSelect } from 'tdesign-react';
