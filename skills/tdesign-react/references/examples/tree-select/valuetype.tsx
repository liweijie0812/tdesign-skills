/**
 * TDesign TDesign React 示例：tree-select - valuetype
 * 覆盖组件：Tree-select
 * 来源：组件库源码 packages/components/tree-select/_example/valuetype.tsx
 */

import React, { useState } from 'react';
import { Space, TreeSelect } from 'tdesign-react';
