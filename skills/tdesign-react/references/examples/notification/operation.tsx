/**
 * TDesign TDesign React 示例：notification - operation
 * 覆盖组件：Notification
 * 来源：组件库源码 packages/components/notification/_example/operation.tsx
 */

import React from 'react';
import { Button, Notification, Space } from 'tdesign-react';
