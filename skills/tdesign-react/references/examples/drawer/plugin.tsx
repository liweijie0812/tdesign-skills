/**
 * TDesign TDesign React 示例：drawer - plugin
 * 覆盖组件：Drawer
 * 来源：组件库源码 packages/components/drawer/_example/plugin.tsx
 */

import React from 'react';
import { Button, drawer, DrawerPlugin, Space } from 'tdesign-react';
