/**
 * TDesign TDesign React 示例：upload - custom-drag
 * 覆盖组件：Upload
 * 来源：组件库源码 packages/components/upload/_example/custom-drag.tsx
 */
...
import type { TriggerContext, UploadFile, UploadInstanceFunctions, UploadProps } from 'tdesign-react';
