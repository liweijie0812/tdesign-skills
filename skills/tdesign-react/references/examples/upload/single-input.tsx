/**
 * TDesign TDesign React 示例：upload - single-input
 * 覆盖组件：Upload
 * 来源：组件库源码 packages/components/upload/_example/single-input.tsx
 */

import React, { useRef, useState } from 'react';
import { Button, Checkbox, MessagePlugin, Space, Upload } from 'tdesign-react';
