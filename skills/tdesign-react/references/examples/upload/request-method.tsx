/**
 * TDesign TDesign React 示例：upload - request-method
 * 覆盖组件：Upload
 * 来源：组件库源码 packages/components/upload/_example/request-method.tsx
 */

import React, { useCallback, useRef, useState } from 'react';
import { MessagePlugin, Radio, Space, Upload } from 'tdesign-react';
