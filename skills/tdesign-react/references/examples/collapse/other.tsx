/**
 * TDesign TDesign React 示例：collapse - other
 * 覆盖组件：Collapse
 * 来源：组件库源码 packages/components/collapse/_example/other.tsx
 */

import React, { useState } from 'react';
import { Checkbox, Collapse, Space, TagInput } from 'tdesign-react';
