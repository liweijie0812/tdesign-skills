...
- [通用契约](./dialog/contract.md)：跨 Web、移动端、小程序和 uni-app 都成立的 Dialog 任务语义。
...
- [小程序 / uni-app 差异](./dialog/miniprogram.md)：小程序与 uni-app Dialog 属性、事件、插槽和样式边界。
...
- [小程序 / uni-app 子组件](./sub-components/miniprogram.md)：小程序与 uni-app 子组件、插槽和样式入口使用语义。

## 不在这里维护的内容

- 不维护完整 props、事件、插槽、CSS Variables 或类型定义。
- 不维护导入语句、组件注册方式、小程序 JSON 配置或 uni-app easycom 配置。
