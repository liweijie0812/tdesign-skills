...
- Mobile React：`skills/tdesign-mobile-react/references/api/dialog/index.md`，类型源为 `skills/tdesign-mobile-react/references/api/dialog/type.ts` 和 `skills/tdesign-mobile-react/references/api/common.ts`。
- Mobile Vue：`skills/tdesign-mobile-vue/references/api/dialog/index.md`，类型源为 `skills/tdesign-mobile-vue/references/api/dialog/type.ts`、`skills/tdesign-mobile-vue/references/api/dialog/props.ts` 和 `skills/tdesign-mobile-vue/references/api/common.ts`。
