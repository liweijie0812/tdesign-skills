...
- React：`skills/tdesign-react/references/api/dialog/index.md`，类型源为 `skills/tdesign-react/references/api/dialog/type.ts` 和 `skills/tdesign-react/references/api/common.ts`。
- Vue Next：`skills/tdesign-vue-next/references/api/dialog/index.md`，类型源为 `skills/tdesign-vue-next/references/api/dialog/type.ts`、`skills/tdesign-vue-next/references/api/dialog/props.ts` 和 `skills/tdesign-vue-next/references/api/common.ts`。
- Vue 2：`skills/tdesign-vue2/references/api/dialog/index.md`，类型源为 `skills/tdesign-vue2/references/api/dialog/type.ts`、`skills/tdesign-vue2/references/api/dialog/props.ts` 和 `skills/tdesign-vue2/references/api/common.ts`。
