...
上游文档：https://raw.githubusercontent.com/Tencent/tdesign-vue/develop/src/space/space.md
...
separator | String / Slot / Function | - | 分隔符。TS 类型：`string \| TNode`。[通用类型定义](../common.ts) | N
