...
本目录包含从 TDesign Vue 2 组件库源码自动提取的示例代码（已精简，每组件仅保留基础示例和关键变体）。
...
| Anchor | `anchor/` | 3 | base.vue, customize-highlight.vue, multiple.vue |
...
| Breadcrumb | `breadcrumb/` | 2 | base.vue, custom.vue |
| Button | `button/` | 2 | base.vue, custom-element.vue |
...
| Cascader | `cascader/` | 5 | base.vue, custom-options.vue, disabled.vue, multiple.vue |
...
| Date-picker | `date-picker/` | 5 | base.vue, custom-icon.vue, date-presets-alt.vue, multiple.vue |
| Descriptions | `descriptions/` | 2 | base.vue, custom-style.vue |
| Dialog | `dialog/` | 4 | async.vue, base.vue, custom.vue, plugin.vue |
...
| Guide | `guide/` | 6 | base.vue, custom-popup.vue, dialog-body.vue, dialog.vue |
...
| Pagination | `pagination/` | 3 | base.vue, customizable.vue, disabled.vue |
| Popconfirm | `popconfirm/` | 1 | base.vue |
| Popup | `popup/` | 3 | base.vue, disabled.vue, plugin.vue |
| Progress | `progress/` | 1 | custom.vue |
...
| Time-picker | `time-picker/` | 4 | base.vue, disabled.vue, format.vue, panel.vue |
| Timeline | `timeline/` | 4 | base.vue, customContent.vue, customDot.vue, loading.vue |
| Tooltip | `tooltip/` | 1 | base.vue |
| Transfer | `transfer/` | 3 | base.vue, custom.vue, disabled.vue |
