...
- `tdesign-usage-guide/references/decisions/`：回答“该选什么、为什么”。其中 `component-usage-map.md` 是轻量索引，`components/` 是按组件拆分的详细规则。
...
- 为节省上下文，优先读平台 `component-usage-map.md`，只有需要更细规则时才读 `components/` 下单组件文档。
