...
适用于 `tdesign-react`、`tdesign-vue-next` 和 `tdesign-vue`。本文只给 Web 组合方向，具体 props、事件、插槽和导入方式必须查当前技术栈 skill 的 `references/api/<component>/index.md`。
...
- 查阅：`skills/tdesign-composition/references/scenarios/layout-shell.md`、`skills/tdesign-composition/references/design/layout.md`、`skills/tdesign-composition/references/design/offices.md`。
...
- 查阅：`skills/tdesign-composition/references/scenarios/table-list-page.md`、`skills/tdesign-composition/references/design/offices-task.md`。
...
- 查阅：`skills/tdesign-composition/references/design/offices-task.md`。
