...
1. Web 查 `web/anti-patterns.md`。
2. Mobile / Miniprogram 查 `mobile/anti-patterns.md`。
3. 跨端 API、子组件和插槽差异查 `skills/tdesign-docs/references/api/shared/`。
4. 当前栈真实 API 查对应技术栈 skill 的 `references/api/<component>/index.md`。
