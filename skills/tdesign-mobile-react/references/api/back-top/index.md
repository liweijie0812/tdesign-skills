...
上游文档：https://raw.githubusercontent.com/Tencent/tdesign-mobile-react/develop/src/back-top/back-top.md
...
icon | TNode | true | 图标。TS 类型：`boolean \| TNode`。[通用类型定义](../common.ts) | N
