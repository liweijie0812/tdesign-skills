...
组件简介：用于信息分类后的展示切换或锚点，位于页面左侧。

上游文档：https://raw.githubusercontent.com/Tencent/tdesign-mobile-react/develop/src/side-bar/side-bar.md
...
children | TNode | - | 侧边导航内容。TS 类型：`TNode`。[通用类型定义](../common.ts) | N
...
className | String | - | 类名 | N
style | Object | - | 样式，TS 类型：`React.CSSProperties` | N
badgeProps | Object | - | 透传至 Badge 组件。TS 类型：`BadgeProps`，[Badge API Documents](../badge/index.md)。[详细类型定义](./type.ts) | N
