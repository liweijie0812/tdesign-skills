...
上游文档：https://raw.githubusercontent.com/Tencent/tdesign-mobile-react/develop/src/overlay/overlay.md
...
children | TNode | - | 遮罩内容。TS 类型：`string \| TNode`。[通用类型定义](../common.ts) | N
