...
上游文档：https://raw.githubusercontent.com/Tencent/tdesign-mobile-react/develop/src/empty/empty.md
...
icon | TNode | - | 图标。TS 类型：`string \| TNode`。[通用类型定义](../common.ts) | N
image | TNode | - | 图片地址。TS 类型：`string \| TNode`。[通用类型定义](../common.ts) | N
