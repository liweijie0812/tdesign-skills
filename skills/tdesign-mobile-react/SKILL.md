...
description: 当项目使用 tdesign-mobile-react，且任务需要 React Mobile 组件 API、props、事件、类型、导入方式、示例代码或实现/修复 TDesign 移动端 React UI 时使用。只读取 references/api/ 和 references/examples/。
---
