...
- Mobile React 查 `api/mobile-react/table/index.md`，表格能力和交互密度不等同 Web。
- Mobile Vue 查 `api/mobile-vue/table/index.md`，事件、列配置和插槽按移动端 Vue API。
- Miniprogram 查 `api/miniprogram/table/index.md`，属性、事件和插槽按小程序 API。
